...
SUM(TempYear2.SumYear02), SUM(TempYear1.SumYear01),
SUM(Temp04.product_sell_sum), SUM(Temp04.product_buy_sum), 
SUM(Temp04.product_buy_tabco), SUM(Temp05.data3), 
SUM(Temp06.service_value), SUM(Temp07.report_value)
...
ReportGroup2.amccode
FROM ReportGroup2
WHERE ReportGroup2.report_year = '2551'
AND ReportGroup2.report_month = '3'
...
ReportGroup3.amccode
FROM ReportGroup3
WHERE ReportGroup3.report_year = '2551'
AND ReportGroup3.report_month = '3'
...
ReportGroup4.amccode
FROM ReportGroup4
WHERE ReportGroup4.report_year = '2551'
AND ReportGroup4.report_month = '3'
...
ReportGroup2.amccode
FROM ReportGroup2
WHERE ReportGroup2.report_year = '2550'
AND ReportGroup2.report_month = '3'
...
ReportGroup3.amccode
FROM ReportGroup3
WHERE ReportGroup3.report_year = '2550'
AND ReportGroup3.report_month = '3'
...
ReportGroup4.amccode
FROM ReportGroup4
WHERE ReportGroup4.report_year = '2550'
AND ReportGroup4.report_month = '3'
