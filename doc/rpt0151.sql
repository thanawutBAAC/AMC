SELECT userlogin.br_code, 
userlogin.userdetail,
BaseReportDetail.report_detail_name,
...
FROM userlogin,BaseReportDetail,BaseReportHeader 
...
WHERE userlogin.amccode = BaseReportHeader.amccode
AND BaseReportHeader.report_group_code = BaseReportDetail.report_group_code
AND BaseReportHeader.report_detail_code = BaseReportDetail.report_detail_code
AND BaseReportHeader.report_group_code = '3'
AND userlogin.status = 'N'

GROUP BY userlogin.br_code, userlogin.userdetail, 
BaseReportDetail.report_detail_name WITH ROLLUP