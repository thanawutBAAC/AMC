  ...
  <tr> 
    <td height="884" valign="top" class="boxleft15"><table style="margin: 7px 0px 0px 0px" cellSpacing="1" cellPadding="0" width="700" border="0" class=font1 bgcolor=white>
      ...
      <table style="margin: 7px 0px 0px 0px" cellspacing="1" cellpadding="0" width="700" border="0" class=font1 bgcolor=white>
        <tr align="left" bgcolor="#999999" class=font1 style="color:#333333"> 
        ...
        <tr align="center" bgcolor="#CCCCCC" class=font1 style="color:#333333"> 
...
<br>
      ...
      <table width="98%" border="0" cellPadding="0" cellSpacing="1" bgcolor=white class=font1 >
		...
		<?
			...
			{
		?>
        <input  style="width:130px"type="submit" name="Submit2" value="ต้องการพิมพ์ส่วนนี้"  onClick="window.open('rpt_amc_detail2.php?AMCCode=<?echo $AMCCode;?>&SendYear=<?echo $SendYear?>&type=print')"> 
        &nbsp; <input  style="width:130px"type="submit" name="Submit22" value="ส่งข้อมูลออกเป็น Excel"  onClick="window.open('rpt_amc_detail2.php?AMCCode=<?echo $AMCCode;?>&SendYear=<?echo $SendYear?>&excel=export')">
        <?}?>
		<br>
        <br>
    </tr>
