    ...
    <td align="center" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr> 
          <td height="30" valign="bottom" class="boxleft50"><br>
            <br>
            <img src="images/head_network.jpg">&nbsp;</td>
        ...
        <tr> 
          <td height="50" colspan="2" align="center" valign="middle"><table width="90%" border="0" cellpadding="0" cellspacing="0">
			...
			//			  <input type="radio" name="rdo1" value="1" checked OnClick="document.form1.lstBrn.disabled=false;">
                        ...
                        <td bgcolor="#F0F0F0" style="color:#FF0080;border:1px solid #F0F0F0;"><input name="valuesbuy<?=$i?>" type="text" class="Assetsize" style="text-align: right;" value="<?echo $rowall[7]?>" onkeypress=check_number();> 
                        </td>
                        <td bgcolor="#F0F0F0"><input name="valuessell<?=$i?>" type="text" class="Assetsize" style="text-align: right;" value="<?echo $rowall[8]?>" onkeypress=check_number();> 
                        </td>
                        <td bgcolor="#F0F0F0" style="color:#FF0080;border:1px solid #F0F0F0;"><input name="valuesservice<?=$i?>" type="text" class="Assetsize" style="text-align: right;" value="<?echo $rowall[9]?>" onkeypress=check_number();></td>
				...
				?>
                        ...
                        <td height="20" bgcolor="#F8F1C7" > <input type="radio" name="typeservice<?=$i?>"  value="1"  Onclick="document.form1.valuesservice<?=$i?>.disabled=false;">
                          ...
                          ไม่มี</td>
                        <td bgcolor="#F8F1C7" style="color:#FF0080;border:1px solid #F0F0F0;"><input name="valuesbuy<?=$i?>" type="text" class="Assetsize" style="text-align: right;" onkeypress=check_number();></td>
                        <td bgcolor="#F8F1C7"><input name="valuessell<?=$i?>" type="text" class="Assetsize" style="text-align: right;" onkeypress=check_number();></td>
                        <td bgcolor="#F8F1C7" style="color:#FF0080;border:1px solid #F0F0F0;"><input name="valuesservice<?=$i?>" type="text" class="Assetsize" style="text-align: right;" onkeypress=check_number();></td>
