...
function bodyOnLoad() {
	...
	<?if($committeetype=="01"){?>
		//alert("22222222");
			//document.forms[0].rdo_CommitteeAMC.disabled=false;
                ...
                <td align="center" valign="top" ><form name="form1" method="get" action="committee_updatedata.php" >
                    <table style="margin: 7px 0px 0px 0px" cellSpacing="1" cellPadding="0" width="600" border="0" class=font1 bgcolor=white>
                      ...
                      <tr align=center bgcolor="#F0F0F0" style="color:#666666;"> 
                        ...
                        <td align="left" class="boxleft5">
                          <?
						 $committeebrithday=trim($committeebrithday);
                          ...
                          <select name="ddate" class="datetime">
							...
							?>
								...
								for(i=0;i<=(document.form1.ddate.length-1);i++) {
									if(document.form1.ddate.options[i].value=="<?echo substr($committeebrithday,0,strpos($committeebrithday,"/"));?>") {
                          ...
                          <select name="dmonth" class="datemonth">
                            ...
                            <option value="12">ธันวาคม</option>
								...
								for(i=0;i<=(document.form1.dmonth.length-1);i++) {
									if(document.form1.dmonth.options[i].value=="<?echo substr($committeebrithday,strpos($committeebrithday,"/")+1,2);?>") {
                          ...
                          <select name="dyear" class="dateyear">
							...
							?>
								...
								for(i=0;i<=(document.form1.dyear.length-1);i++) {
									if(document.form1.dyear.options[i].value=="<?echo substr($committeebrithday,-4)?>") {
