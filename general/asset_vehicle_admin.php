          ...
          <tr> 
            <td align="center" valign="top"><table style="margin: 7px 0px 0px 0px" cellSpacing="1" cellPadding="0" width="80%" border="0" class=font1 bgcolor=white>
                <tr bgcolor="#92AED1" align=center class=font1 style="color:#333333;"> 
                  <td height="19" colspan=10 align=left><b>&nbsp; &nbsp;3. เพิ่มข้อมูลทรัพย์สินประเภทยานพาหนะ</b></td>
                </tr>
                ...
                <?php
								...
								$sql.=" where assettype='03' and assetcategory<>'00' ";									 
                ...
                <tr bgcolor="#F0F0F0" align=center class=font1 style="color:#666666;"> 
                  ...
                  <td align="center" style="border:1px solid #F0F0F0;"><a href="asset_update_admin.php?type=03&category=<?echo $rowall[1]?>">แก้ไข</a></td>
                  <td align="center" style="border:1px solid #F0F0F0;"><a  href="javascript: if(confirm('การลบข้อมูลทรัพย์สินจะมีผลต่อข้อมูลทรัพย์สินทุกของ สกต. ต้องการลบหรือไม่ !!')){ window.location='asset_delete_admin.php?assettype=03&assetcategory=<?echo $rowall[1];?>';}">ลบข้อมูล</a></td>
                </tr>
                <?php
						$i++;			
                ...
                <tr bgcolor="#F8F1C7" align=center class=font1 style="color:#666666;"> 
                  <td height="20" align=center bgcolor="#F8F1C7">&nbsp; 
                    <?
						...
						//	$cat="0101";
				?>
                    <input type="hidden" name="assettype" value="03" > <input type="hidden" name="new[]" value="1" id="new[]2"> 
                    <b> </b> <b> </b> </td>
                  ...
                  <td colspan="4" align=left class="boxleft10" <? echo 'height="'.$bb.'" '?>colspan="6"> 
                    <?
				  		if($new<>"1")
							{
				  ?>
                    <a href="asset_vehicle_admin.php?&row=<?echo$a+1;?>&new=1">เพิ่มรายการใหม่</a> 
                    <?
							}
					?>
                    <b> 
                    <input type="hidden" name="row" value="<?=$a;?>">
                    <input type="hidden" name="assettype" value="03">
                    </b></td>
                </tr>
              </table>
              <br>
