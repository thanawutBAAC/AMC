...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr> 
    <td height="884" valign="top" class="boxleft15"><table style="margin: 7px 0px 0px 0px" cellSpacing="0" cellPadding="0" width="700" border="1" class=font1 bgcolor=white>
        <tr bgcolor="#999999" class="font1"> 
          <td height="19" colspan=3 align=left><b>&nbsp; &nbsp;ข้อมูลทั่วไป <? echo 'สกต.'.$AMCName. 'ณ 
            ปี  '.$SendYear.'</b>';
			?>
          </td>
        </tr>
        <tr align="left" bgcolor="#CCCCCC" style="color:#333333"> 
          <td height="25" colspan="3" class="boxleft30"> <? echo '- สกต. จังหวัด '.$AMCName;?></td>
        </tr>
        <tr align=center style="color:#666666;"> 
          <td height="20" align=center bgcolor="#F0F0F0">1.</td>
          <td height="20" align="left" bgcolor="#F0F0F0" class="boxleft5">เลขทะเบียน สกต. : </td>
          <td align="left" bgcolor="#F0F0F0" class="boxleft5"> 
            <?=$rs["AMCCode"]?>
          </td>
        </tr>
        <tr align=center style="color:#666666;"> 
          <td height="20" align=center bgcolor="#F0F0F0">2.</td>
          <td height="20" align="left" bgcolor="#F0F0F0" class="boxleft5">วันที่จดทะเบียน : </td>
          <td align="left" bgcolor="#F0F0F0" class="boxleft5"> 
            <?=$rs["AMCRegisDate"]?>
          </td>
        </tr>
        <tr align=center style="color:#666666;"> 
          ...
          <td height="20" align="left" bgcolor="#F0F0F0" class="boxleft5">ที่ตั้ง สกต. : </td>
          <td align="left" bgcolor="#F0F0F0" class="boxleft5"> 
            <?=$rs["AMCAddress"]?>
            <?  
        ...
        <tr align=center style="color:#666666;"> 
          ...
          <td height="20" align="left" bgcolor="#F0F0F0" class="boxleft5">หมายเลขโทรศัพท์ : </td>
          <td align="left" bgcolor="#F0F0F0" class="boxleft5"> 
            <?  
        ...
        <tr align=center style="color:#666666;"> 
          ...
          <td width="22%" height="20" align="left" bgcolor="#F0F0F0" class="boxleft5">หมายเลข wan 
            : </td>
          <td width="69%" align="left" bgcolor="#F0F0F0" class="boxleft5"> 
            <?  
        ...
        <tr align=center style="color:#666666;"> 
          ...
          <td width="22%" height="20" align="left" bgcolor="#F0F0F0" class="boxleft5">Fax. : </td>
          <td width="69%" align="left" bgcolor="#F0F0F0" class="boxleft5"> 
            <?  
        ...
        <tr align=center style="color:#666666;"> 
          ...
          <td width="22%" height="20" align="left" bgcolor="#F0F0F0" class="boxleft5">Internet ของ 
            สกต. : </td>
          <td width="69%" align="left" bgcolor="#F0F0F0" class="boxleft5"> 
        ...
        <tr align=center style="color:#666666;"> 
          <td height="20" rowspan="3" align=center bgcolor="#F0F0F0">8. </td>
          <td height="20" align="left" bgcolor="#F0F0F0" class="boxleft5">ชื่อ-สกุล : </td>
          <td align="left" bgcolor="#F0F0F0" class="boxleft5"> 
            <?  
        ...
        <tr> 
        <tr align=center style="color:#666666;"> 
          <td height="20" rowspan="3" align=center bgcolor="#F0F0F0">9. </td>
          <td height="20" align="left" bgcolor="#F0F0F0" class="boxleft5">ชื่อ-สกุล : </td>
          <td align="left" bgcolor="#F0F0F0" class="boxleft5"> 
      ...
      <br>
      <br>
      <table style="margin: 7px 0px 0px 0px" cellspacing="0" cellpadding="0" width="700" border="1" class=font1 bgcolor=white>
        <tr align="left" class=font1 style="color:#333333"> 
          <td height="19" colspan="9" bgcolor="#999999" class="boxleft5"> <b> 
            <?
        ...
        <tr align="center" class=font1 style="color:#333333"> 
          <td width=4% height="28" bgcolor="#CCCCCC"><b>ลำดับ</b></td>
          <td width=13% bgcolor="#CCCCCC"><b>ชื่อ สกต.</b></td>
          <td width="20%" bgcolor="#CCCCCC"><b> ประเภททรัพย์สิน </b></td>
          <td width=10% bgcolor="#CCCCCC"><b>ขนาด</b></td>
          <td width="5%" align="center" bgcolor="#CCCCCC"><b>จำนวน</b></td>
          <td width="8%" align="center" bgcolor="#CCCCCC"><b>ประเภท</b></td>
          <td width=10% bgcolor="#CCCCCC"><b>มูลค่าปัจจุบัน</b></td>
          <td width="10%" bgcolor="#CCCCCC"><b>การใช้ประโยชน์</b></td>
          <td width="27%" bgcolor="#CCCCCC"><b>หมายเหตุ</b></td>
        </tr>
        <?		
								$type=$org_searchtype;
        ...
        <tr align=left style="color:#666666;"> 
          ...
          <td bgcolor="#F0F0F0" class="boxleft15" ><?echo $rowall[6]?></td>
      ...
      <br>
      <br>
      <table width="1600" border="1" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="font1">
        <tr bgcolor="#999999" class="font1"> 
        ...
        <tr align="center" bgcolor="#CCCCCC" style="color:#333333"> 
        ...
        <tr align="center" bgcolor="#BBD0E1"> 
          <td width="40" height="18" bgcolor="#CCCCCC">วาระ</td>
          <td width="40" bgcolor="#CCCCCC">ปี</td>
        </tr>
        <?		
								$type=$org_searchtype;
								$page=30;  // กำหนดให้แต่ละเพจแสดงรายการทั้งหมด 40 รายการ
...
<br>
<br>
      <table width="1200" border="1" cellPadding="0" cellSpacing="0" bgcolor=white class=font1 >
        <tr align=center bgcolor="#999999" style="color:#333333;"> 
