...
//	alert(pin);
	...
	if (digit != pin.charAt(12)) {
		alert(' รหัสประชาชนไม่ถูกต้อง'); frm.user_id.focus(); return;
	}
	return true;
}
...
function verify(frm) {
       ...
       {alert('รหัสประชาชนไม่ถูกต้อง'); frm.user_id.focus(); return false;}
	
	with( frm )
	 { 
		if(frm.user_id.value == "" ) { alert("ตรวจสอบรหัสประจำตัวประชาชนให้ถูกต้อง"); frm.user_id.focus(); return; }	
		//if(frm.user_id.value.length < 13 ) { alert("ระบุรหัสประจำตัวประชาชนให้ครับ 13 หลัก"); frm.user_id.focus(); return; }
		if(frm.name.value == "" ) { alert("ตรวจสอบชื่อให้ถูกต้อง"); frm.name.focus(); return; }
		if(frm.lsname.value == "" ) { alert("ตรวจสอบนามสกุลให้ถูกต้อง"); frm.lsname.focus(); return; }
		if(frm.birthday.value == "" ) { alert("ตรวจสอบ วัน/เดือน/ปีเกิด ให้ถูกต้อง"); frm.birthday.focus(); return ; } 
		if(frm.phone.value.length < 10  ) { alert("ระบุรหัสหายเลขโทรศัพท์ให้ครับ 10 หลัก"); frm.phone.focus(); return; }
    ...
    <td align="center" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr> 
		  ...
		  <?
				...
				{ 
					print '<script>alert(" รหัสประชาชน '.$user_id.' มีข้อมูลพนักงานระบบอยู่แล้ว ");</script>';
			 	}
		  ?>
		  </td>
        </tr>
                ...
                <td align="center" valign="top" ><form name="form1" method="get" action="personnel_insertinto.php">
                    <table style="margin: 7px 0px 0px 0px" cellSpacing="1" cellPadding="0" width="70%" border="0" class=font1 bgcolor=white>
                      ...
                      <tr align=center bgcolor="#F0F0F0" style="color:#666666;"> 
                        ...
                        <td height="20" align="left" class="boxleft5">ชื่อ : 
                        </td>
