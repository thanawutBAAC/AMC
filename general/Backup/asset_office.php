            ...
            <td align="center" valign="top"><table style="margin: 7px 0px 0px 0px" cellSpacing="1" cellPadding="0" width="95%" border="0" class=font1 bgcolor=white>
                <tr bgcolor="#92AED1" align=center class=font1 style="color:#333333;"> 
                  <td height="19" colspan=7 align=left><b>&nbsp; &nbsp;4. ข้อมูลทรัพย์สินประเภทครุภัณฑ์ 
                    เครื่องใช้สำนักงาน</b> ( ที่มีมูลค่าเกิน 1 หมื่นบาท )</td>
                </tr>
                ...
                <tr bgcolor="#F0F0F0" align=center class=font1 style="color:#666666;"> 
                  <td height="20" align=left bgcolor="#F0F0F0">&nbsp;&nbsp;&nbsp; 
					...
					?>
                    <b> </b> </td>
                  <td height="20"><input name="assetamount[]" type="text" class="AssetSize" id ="assetamount<?=$a?>"value="<?echo $rowall[5]?>" style="text-align: center;" onchange="chkItem(this,document.getElementById('assetvalues<?=$a?>'),document.forms[0].assetapplying<?=$i?>);"></td>
				...
				?>
                  ...
                  <td height="20"> <input name="assetamount[]" type="text" class="Assetsize" id="assetamount<?=$a?>" style="text-align: center;"></td>
