...
<div id="SiXhEaD_Excel" align=center x:publishsource="Excel"> 
    <table style="margin: 7px 0px 0px 0px" cellSpacing="1" cellPadding="0" width="100%" border="0" class=font1 bgcolor=white>
				...
				<tr > 
					<td height="2" colspan="3" bgcolor="#C8D7E3"></td>
				</tr>
           </table>
        ...
        <tr> 
          <td height="50" align="center" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#FFFFFF" class="font1">
              <form name="form1" method="GET" action="committee_show.php" target="AssetMain">
                <tr bgcolor="#92AED1" class="font1"> 
                  <td height="23" colspan="12" class="boxleft15" ><b>ข้อมูลคณะกรรมการ&nbsp;</b> 
               <!--      <?
                ...
                <tr align="center" bgcolor="#BBD0E1"> 
				 ...
				 <?
					   if($numsql == "0")
							{
						 ?>
					  <tr align=center class=font1><td bgcolor="#F0F0F0" colspan ="12" height="30" ><div align='center'><span class='txtred'>!!! ไม่มีข้อมูลข้อมูลคณะกรรมการ</span></div></td></tr>	
					  <?
							 }else{
					 ?>
                <?
                ...
                <tr bgcolor="#F0F0F0" style="color:#666666;"> 
                  ...
                  <td align="center"><table width="100%" height="100%" border="0" cellpadding="0" cellspacing="3" class="font1" style="color:#666666;">
                      <tr> 
                        <td align="center" bgcolor="#F0F0F0"><?echo $show_id?></td>
                      </tr>
                    </table></td>
                  <td align="center"><table width="100%" height="100%" border="0" cellpadding="0" cellspacing="3" class="font1" style="color:#666666;">
                      <tr> 
                        <td align="left" bgcolor="#F0F0F0" class="boxleft5"><?echo $rowall[13]?></td>
                      </tr>
                    </table></td>
                  <td align="center"><table width="100%" height="100%" border="0" cellpadding="0" cellspacing="3" class="font1" style="color:#666666;">
                      <tr> 
                        <td align="left" bgcolor="#F0F0F0"class="boxleft5"><?echo $rowall[14]?></td>
                      </tr>
                    </table></td>
                  <td align="center"><table width="100%" height="100%" border="0" cellpadding="0" cellspacing="3" class="font1" style="color:#666666;">
                      <tr> 
                  ...
                  <td align="center"><table width="100%" height="100%" border="0" cellpadding="0" cellspacing="3" class="font1" style="color:#666666;">
                      <tr> 
                        <td align="center" bgcolor="#F0F0F0"><?echo $rowall[17]?></td>
                      </tr>
                    </table></td>
                  <td align="center"><table width="100%" height="100%" border="0" cellpadding="0" cellspacing="3" class="font1" style="color:#666666;">
                      <tr> 
                        <td align="center" bgcolor="#F0F0F0"><?echo $rowall[6]?></td>
                      </tr>
                    </table></td>
                  <td align="center"><table width="100%" height="100%" border="0" cellpadding="0" cellspacing="3" class="font1" style="color:#666666;">
                      <tr> 
                        <td align="center" bgcolor="#F0F0F0"><?echo $rowall[7]?></td>
                      </tr>
                    </table></td>
                  <td align="center"><table width="100%" height="100%" border="0" cellpadding="0" cellspacing="3" class="font1" style="color:#666666;">
                      <tr> 
                        <td align="center" bgcolor="#F0F0F0"><?echo $AMC[$rowall[18]]?></td>
                      </tr>
                    </table></td>
                  <td align="center"><table width="100%" height="100%" border="0" cellpadding="0" cellspacing="3" class="font1" style="color:#666666;">
                      <tr> 
                        <td align="left" bgcolor="#F0F0F0" class="boxleft5"><?echo $Education[$rowall[19]]?></td>
                      </tr>
                    </table></td>
                  <td align="center"><table width="100%" height="100%" border="0" cellpadding="0" cellspacing="3" class="font1" style="color:#666666;">
                      <tr> 
                        <td align="center" bgcolor="#F0F0F0" class="boxleft5"> 
                          <?
                ...
                <td align="center" valign="top" >
                    <table style="margin: 7px 0px 0px 0px" cellSpacing="1" cellPadding="0" width="100%" border="0" class=font1 bgcolor=white>
                      <tr align=center bgcolor="#92AED1" class=font1 style="color:#333333;"> 
                        <td height="19" colspan=12 align=left><b>&nbsp; ข้อมูลบุคลากร 
                    <!--       <?
					...
					?>
					   ...
					   if($numsql == "0")
							{
						 ?>
					  <tr align=center class=font1><td bgcolor="#F0F0F0" colspan ="12" height="30" colspan=8  ><div align='center'><span class='txtred'>!!! ไม่มีข้อมูลบุคลากร</span></div></td></tr>	
					  <?
							 }else{
					 ?>
                      <?
                            ...
                            <tr> 
                              <td height="15" align="center" bgcolor="#FFFFFF" class="tohoma"> 
                                <?
									...
									if($rowall[13]=="2"){echo "ประถมศึกษา - มัธยมศึกษา";}
									if($rowall[13]=="3"){echo "มัธยมศึกษา - อนุปริญญา";}
									if($rowall[13]=="4"){echo "อนุปริญญา - ปริญญาตรี";}
									if($rowall[13]=="5"){echo "สูงกว่าปริญญาตรี";}
								?>
                              </td>
                            </tr>
                          </table></td>
                        <td style="color:#FF0080;border:1px solid #F0F0F0;"><input name="phone<?=$i?>" type="text" class="Assetsize" style="text-align: left;" maxlength="10" value="<? if($rowall[14]==""){ echo "-";} else { echo $rowall[14];}?>" readonly=""></td>
                        <td style="color:#FF0080;border:1px solid #F0F0F0;"><input name="remark<?=$i?>" type="text" class="Assetsize" style="text-align: left;" value="<? if($rowall[16]==""){ echo "-";} else { echo $rowall[16];}?>" readonly=""></td>
    ...
    <td align="center" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr> 
          <td height="50" align="center" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#FFFFFF" class="font1">
              <form name="form1" method="GET" action="committee_show.php" target="AssetMain">
                <tr bgcolor="#92AED1" class="font1"> 
                  <td height="23" colspan="18" class="boxleft15" ><b>ข้อมูลคณะกรรมการ&nbsp;</b> 
                    <script language=JAVAScript> 
										for(i=0;i<=(document.form1.SendYear.length-1);i++) {
											if(document.form1.SendYear.options[i].value=="<? echo $SendYear ?>") {
												document.form1.SendYear.options[i].selected = true;
          ...
          <td width="40">ปี</td>
				 ...
				 <?
					   if($numsql == "0")
							{
						 ?>
					  <tr align=center class=font1><td bgcolor="#F0F0F0" colspan ="18" height="30"  ><div align='center'><span class='txtred'>!!! ไม่มีข้อมูลข้อมูลคณะกรรมการ</span></div></td></tr>	
					  <?
							 }else{
					 ?>
                <?
...
<!-- 						<td width="5%">ลบข้อมูล</td> -->
					...
					?>
					   ...
					   if($numsql == "0")
							{
						 ?>
					  <tr align=center class=font1><td bgcolor="#F0F0F0" colspan ="12" height="30"><div align='center'><span class='txtred'>!!! ไม่มีข้อมูลบุคลากร</span></div></td></tr>	
					  <?
							 }else{
					 ?>
                      <?
					...
					/*-----------------------------------------------------------------------------------------------------------------*/	
                      ...
                      <tr align=center bgcolor="#F0F0F0" style="color:#666666;"> 
						...
						<td height="20" > <?
									...
									if($rowall[13]=="5"){echo "สูงกว่าปริญญาตรี";}
								?></td>
                        <td border:1px solid #F0F0F0;"><? if($rowall[14]==""){ echo "-";} else { echo $rowall[14];}?></td>
                         <td border:1px solid #F0F0F0;"><? if($rowall[15]==""){ echo "-";} else { echo $rowall[15];}?></td>
                        <td border:1px solid #F0F0F0;"><? if($rowall[16]==""){ echo "-";} else { echo $rowall[16];}?></td>
                        </td>
                      </tr>
                      <?
					  			$P++;
                ...
                <td align="center" valign="top" >
                    <table style="margin: 7px 0px 0px 0px" cellSpacing="1" cellPadding="0" width="100%" border="0" class=font1 bgcolor=white>
                      ...
                      <tr align="center" bgcolor="#BBD0E1" style="color:#333333"> 
                        ...
                        <td width="10%">ปีที่เข้ามาทำงาน</td>
					  ...
					  <?
					   if($numsql == "0")
							{
						 ?>
					  <tr align=center class=font1><td bgcolor="#F0F0F0" colspan ="9" height="30" colspan=8  ><div align='center'><span class='txtred'>!!! ไม่มีข้อมูลเครือข่ายสมาชิกที่ช่วยงาน สกต.</span></div></td></tr>	
					  <?
							 }else{
					 ?>
                      <?
              ...
              <tr> 
                <td align="center" valign="top" ><br>
                    ...
                    <table style="margin: 7px 0px 0px 0px" cellSpacing="1" cellPadding="0" width="100%" border="0" class=font1 bgcolor=white>
					 ...
					 ?>
                        <td height="19" colspan=8 align=left><b>&nbsp; &nbsp;ข้อมูล 
                          เครือข่ายสาขา &nbsp;<? echo 'ณ ปี '.$Year?></b>&nbsp;<span class="txtred">***หน่วยเป็นบาท</span></td>
					<?
						 }
					?>
                      </tr>
			...
			//			  <input type="radio" name="rdo1" value="1" checked OnClick="document.form1.lstBrn.disabled=false;">
                        ...
                        <td width="13%" height="19" bgcolor="#F0F0F0"> 
                          <?php
								...
								if($typesell=="1")
									{ 
										echo '<input type="radio" name="typesell'.$i.'"  value="1"  checked ><span class="txtgreen" Onclick="document.form1.valuessell'.$i.'.disabled=false;"> มี</span>&nbsp;';
