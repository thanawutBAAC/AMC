          ...
          <tr> 
            <td align="center" valign="top"><table style="margin: 7px 0px 0px 0px" cellSpacing="1" cellPadding="0" width="95%" border="0" class=font1 bgcolor=white>
                ...
                <tr class=font1 align="center" bgcolor="#C8D7E3" style="color:#333333"> 
                  <td width=20%>ที่ดิน</td>
                  <td width="15%"><br>
                    ขนาด<br> <br> </td>
                  <td width=15%>ประเภทที่ดิน</td>
                ...
                <?php
								...
								$sql.=" p.AssetValues, p.AssetApplying, p.AssetRemark ,AssetDetail";
								$sql.=" FROM AssetCode ";
                ...
                <tr bgcolor="#F0F0F0" align=center class=font1 style="color:#666666;">
                  ...
                  <td style="border:1px solid #F0F0F0;"> 
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr> 
                        <td width="80%"><input name="assetsize[]2" type="text" class="AssetSize" value="<?echo $rowall[4]?>" id="assetsize<?=$a;?>" style="text-align: center;" onChange="chkItem(this,document.getElementById('assettypeground<?=$a?>'),document.getElementById('assetvalues<?=$a?>'),document.forms[0].assetapplying<?=$i?>);"></td>
                        <td width="20%"><table width="20" height="17" border="0" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC" class="font1">
                            <tr> 
                  ...
                  <td height="20"><input name="assettypeground[]2" type="text" class="AssetSize" id ="assettypeground[]"value="<?echo $rowall[5]?>" style="text-align: center;" onChange="chkItem(document.getElementById('assetsize<?=$a?>'),this,document.getElementById('assetvalues<?=$a?>'),document.forms[0].assetapplying<?=$i?>);"></td>
                  <td style="color:#FF0080;border:1px solid #F0F0F0;"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="font1">
                      <tr> 
                        <td width="80%"><input name="assetvalues[]2" type="text" class="AssetSize" id="assetvalues[]" value="<?echo $rowall[6]?>" style="text-align: right;" onChange="chkItem(document.getElementById('assetsize<?=$a?>'),document.getElementById('assettypeground<?=$a?>'),this,document.forms[0].assetapplying<?=$i?>);"></td>
				...
				?>
                  ...
                  <td style="color:#FF0080;border:1px solid #F0F0F0;"><input name="assetvalues[]" type="text" class="Assetsize" id="assetvalues<?=$a;?>" style="text-align: right;" onchange="chkItem(document.getElementById('assetsize<?=$a?>'),document.getElementById('assettypeground<?=$a?>'),this,document.forms[0].assetapplying<?=$i?>);"></td>
