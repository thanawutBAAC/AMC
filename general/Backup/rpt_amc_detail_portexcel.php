<? 
//session_start();
$strExcelFileName ="รายงานข้อมูลทั่วไป สกต_$AMCName .xls"; 
...
?>
    <table style="margin: 7px 0px 0px 0px" cellSpacing="1" cellPadding="0" width="100%" border="0" class=font1 bgcolor=white>
                      <tr bgcolor="#92AED1" class="font1">
                        <td height="19" colspan="6" align=left><b>&nbsp; &nbsp;ข้อมูลทั่วไป
							<? if($SendYear==""){ 
									echo "ทั้งหมด";
								 }else{	
									echo 'ณ ปี '.$SendYear;
                      ...
                      <tr align=center bgcolor="#F0F0F0" > 
                        ...
                        <td height="20" align="left" class="boxleft5" colspan="2" >เลขทะเบียน สกต.
                          : </td>
                        <td align="left" class="boxleft5" colspan="3"><?=$rs["AMCCode"]?></td>
                      </tr>
						<tr align=center bgcolor="#F0F0F0" >  
                        <td height="20" align=center>2.</td>
                        <td height="20" align="left" class="boxleft5" colspan="2">วันที่จดทะเบียน
                          : </td>
                        ...
                        <td height="20" align="left" class="boxleft5" colspan="2" rowspan="2">ที่ตั้ง สกต.
                          : </td>
                        ...
                        <td height="20" align="left" class="boxleft5" colspan="2">หมายเลขโทรศัพท์ 
                          : </td>
                        <td align="left" class="boxleft5" colspan="3">
						<?  
                      ...
                      <tr align=center bgcolor="#F0F0F0" > 
                        ...
                        <td width="22%" height="20" align="left" class="boxleft5" colspan="2">หมายเลข wan
                          : </td>
					...
					<tr align=center bgcolor="#F0F0F0" > 
					  ...
					  <tr align=center bgcolor="#F0F0F0"> 
                        ...
                        <td width="22%" height="20" align="left" class="boxleft5" colspan="2">Internet ของ สกต.
                          : </td>
						</td> 
						 <td width="69%" align="left" class="boxleft5" colspan="3">
                        ...
                        <td height="20" align="left" class="boxleft5" colspan="2">ชื่อ-สกุล : 
                        </td>
                        <td align="left" class="boxleft5" colspan="3">
						<?  
                      ...
                      <tr align=center bgcolor="#F0F0F0" > 
                       <!--  <td height="20" align=center >8. </td> -->
                        <td height="20" align="left" class="boxleft5" colspan="2">ตำแหน่ง : 
                        </td>
                        <td align="left" class="boxleft5" colspan="3">
						<?  
        ...
        <tr align="center" bgcolor="#BBD0E1" class=font1 style="color:#333333"> 
		  ...
		  <?
					   if($numrows == "0")
							{
						 ?>
					  <tr align=center class=font1><td bgcolor="#F0F0F0" colspan ="7" height="30"   ><div align='center'><span class='txtred'>!!! ไม่มีข้อมูลด้านทรัพย์สิน</span></div></td></tr>	
					  <?
							 }else{
					 ?>
        <?		
          ...
          <td height="50"  align="center" valign="middle"><!-- <table width="100%" border="0" cellpadding="0" cellspacing="0"> -->
              <tr><form name="form1" method="get" action="networkmember.php">
                <td align="center" valign="top" >
                  <!--   <table style="margin: 7px 0px 0px 0px" cellSpacing="1" cellPadding="0" width="100%" border="0" class=font1 bgcolor=white> -->
                      <tr align=center bgcolor="#92AED1" class=font1 style="color:#333333;"> 
                        <td height="19" colspan="10" align=left><b>&nbsp; ข้อมูลเครือข่ายสมาชิกที่ช่วยงาน สกต. </b>
						</td>
                      </tr>
                      <tr align="center" bgcolor="#BBD0E1" style="color:#333333"> 
                        <td  height="25">ลำดับ</td>
					  ...
					  <?
					   if($numsql == "0")
							{
						 ?>
					  <tr align=center class=font1><td bgcolor="#F0F0F0" colspan ="10" height="30" ><div align='center'><span class='txtred'>!!! ไม่มีข้อมูลเครือข่ายสมาชิกที่ช่วยงาน สกต.</span></div></td></tr>	
					  <?
							 }else{
					 ?>
                      <?
...
<!-- </table> -->
                    ...
                    <table style="margin: 7px 0px 0px 0px" cellSpacing="1" cellPadding="0" width="100%" border="0" class=font1 bgcolor=white>
                      ...
                      <tr align="center" style="color:#333333"> 
                        ...
                        <td height="25" colspan="6" bgcolor="#DABEB6"> ปริมาณธุรกิจ</td>
                      </tr>
                      <tr align="center" style="color:#333333"> 
                        <td width="25%" height="20" align="center" valign="middle" bgcolor="#E0DFD6" colspan="2" >ยอดรวมธุรกิจซื้อ 
                          <br> </td>
                        <td width="25%" bgcolor="#E7D8D8" colspan="2">ยอดรวมธุรกิจขาย</td>
                        <td width="30%" bgcolor="#E0DFD6" colspan="2">ยอดรวมธุรกิจบริการ</td>
                      </tr>
                      <?php
