    ...
    <td align="center" valign="top"> 
      <table style="margin: 7px 0px 0px 0px" cellspacing="1" cellpadding="0" width="98%" border="0" class=font1 bgcolor=white>
        ...
        <tr align=left style="color:#666666;"> 
          ...
          <td height="20" align="center" bgcolor="#F0F0F0"><?echo $rowall[7]?></td>
      ...
      &nbsp; 
      <input  style="width:130px"type="submit" name="Submit22" value="ส่งข้อมูลออกเป็น Excel"  onClick="window.open('rpt_asset_portexcel.php?pagenum=<?echo $pagenum?>&search=<?echo $search?>&div=<?echo $div?>&lis_province=<?echo $lis_province?>&AssetType=<?echo $AssetType?>')">
      <?
	  		}  // if $search;
	  ?>
      <br>
