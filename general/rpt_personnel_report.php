						  ...
						  if ($allpage>1)
								 {
									for($i=1; $i<=$allpage; $i++)
									{
										...
										//ตัดแถวของจำนวนหน้า แถวละ 15 เพจ
											...
											if($mpage<>$modpage)
												{ $br="";}
										echo '<span class="font1">[&nbsp;<a  class="link_page" href ="rpt_personnel_report.php?pagenum='.$b.'&div='.$div.'&lis_province='.$lis_province.'&list_personnel='.$list_personnel.'&txt_user_id='.$txt_user_id.'&list_personnel='.$list_personnel.'&txt_name='.$txt_name.'&txt_lastname='.$txt_lastname.'&txt_phone='.$txt_phone.'&list_education='.$list_education.'&txt_address='.$txt_address.'&list_year='.$list_year.'&rdo_type='.$rdo_type.'">'.$i.'</a>&nbsp;]</font>&nbsp;</span>'.$br;
									}
								}
		  ?>
            <br>
            <br>
            <input  style="width:130px"type="submit" name="Submit22" value="ต้องการพิมพ์ส่วนนี้"  onClick="window.open('rpt_personnel_printing.php?pagenum=<?echo $pagenum?>&div=<?echo $div?>&list_province=<?echo $list_province?>&list_committee=<?echo $list_committee?>&txt_user_id=<?echo $txt_user_id?>&txt_name=<?echo $txt_name?>&txt_lastname=<?echo $txt_lastname?>&txt_phone=<?echo $txt_phone?>&list_education=<?echo $list_education?>&txt_address=<?echo $txt_address?>&list_year=<?echo $list_year?>&rdo_type=<?echo $rdo_type?>')">
            &nbsp; 
            <input  style="width:130px"type="submit" name="Submit232" value="ส่งข้อมูลออกเป็น Excel"  onClick="window.open('rpt_personnel_portexcel.php?pagenum=<?echo $pagenum?>&div=<?echo $div?>&list_province=<?echo $list_province?>&list_committee=<?echo $list_committee?>&txt_user_id=<?echo $txt_user_id?>&txt_name=<?echo $txt_name?>&txt_lastname=<?echo $txt_lastname?>&txt_phone=<?echo $txt_phone?>&list_education=<?echo $list_education?>&txt_address=<?echo $txt_address?>&list_year=<?echo $list_year?>&rdo_type=<?echo $rdo_type?>')">
            <br>
            <br>
          </td>
        </tr>
	  ...
	  <table width="78%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
						  ...
						  if ($allpage>1)
								 {
									for($i=1; $i<=$allpage; $i++)
									{
										...
										//ตัดแถวของจำนวนหน้า แถวละ 15 เพจ
											...
											if($mpage<>$modpage)
												{ $br="";}
										echo '<span class="font1">[&nbsp;<a  class="link_page" href ="rpt_personnel_report.php?pagenum='.$b.'&div='.$div.'&lis_province='.$lis_province.'&list_committee='.$list_committee.'&txt_user_id='.$txt_user_id.'&list_personnel='.$list_personnel.'&txt_name='.$txt_name.'&txt_lastname='.$txt_lastname.'&txt_phone='.$txt_phone.'&list_education='.$list_education.'&txt_address='.$txt_address.'&list_year='.$list_year.'&rdo_type='.$rdo_type.'">'.$i.'</a>&nbsp;]</font>&nbsp;</span>'.$br;
									//echo '<br>'.$b;
										 // echo $pagenum;
									}
								}
		  ...
		  ?>
            <br>
            <br>
    		  <input  style="width:130px"type="submit" name="Submit2" value="ต้องการพิมพ์ส่วนนี้"  onClick="window.open('rpt_personnel_printing.php?pagenum=<?echo $pagenum?>&div=<?echo $div?>&list_province=<?echo $list_province?>&list_committee=<?echo $list_committee?>&txt_user_id=<?echo $txt_user_id?>&txt_name=<?echo $txt_name?>&txt_lastname=<?echo $txt_lastname?>&txt_phone=<?echo $txt_phone?>&list_education=<?echo $list_education?>&txt_address=<?echo $txt_address?>&list_year=<?echo $list_year?>&rdo_type=<?echo $rdo_type?>')">
            &nbsp; 
            <input  style="width:130px"type="submit" name="Submit23" value="ส่งข้อมูลออกเป็น Excel"  onClick="window.open('rpt_personnel_portexcel.php?pagenum=<?echo $pagenum?>&div=<?echo $div?>&list_province=<?echo $list_province?>&list_committee=<?echo $list_committee?>&txt_user_id=<?echo $txt_user_id?>&txt_name=<?echo $txt_name?>&txt_lastname=<?echo $txt_lastname?>&txt_phone=<?echo $txt_phone?>&list_education=<?echo $list_education?>&txt_address=<?echo $txt_address?>&list_year=<?echo $list_year?>&rdo_type=<?echo $rdo_type?>')"> 
          </td>
        </tr>
      </table>
