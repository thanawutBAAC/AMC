...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <table width="98%" border="0" cellpadding="0" cellspacing="0" class="font1">
   ...
   <?
		   ...
		   echo '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class=txt>*** รายการทรัพย์สินพบทั้งหมด <b>'.$numrows.'</b>';
           echo ' รายการ<br>';
                    ...
                    <table style="margin: 7px 0px 0px 0px" cellSpacing="1" cellPadding="0" width="100%" border="0" class=font1 bgcolor=white>
					  ...
					  <?
					   if($numsql == "0")
							{
						 ?>
					  <tr align=center class=font1><td bgcolor="#F0F0F0" colspan ="10" height="30" colspan=8  ><div align='center'><span class='txtred'>!!! ไม่มีข้อมูลเครือข่ายสมาชิกที่ช่วยงาน สกต.</span></div></td></tr>	
					  <?
							 }else{
					 ?>
                      <?
