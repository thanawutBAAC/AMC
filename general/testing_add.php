    ...
    <td align="center" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr> 
          <td height="50" colspan="2" align="center" valign="middle"><table width="98%" border="0" cellpadding="0" cellspacing="0">
              <tr> 
                <td align="center" valign="top" ><form name="form1" method="get" action="testing_insertinto.php" >
                    <table style="margin: 7px 0px 0px 0px" cellSpacing="1" cellPadding="0" width="70%" border="0" class=font1 bgcolor=white>
                      ...
                      <tr align=center bgcolor="#F0F0F0" style="color:#666666;"> 
                        ...
                        <td width="27%" height="20" align="left" class="boxleft5">หมายเลขบัตรประจำตัวประชาชน 
                          : </td>
                        <td colspan="2" align="left" class="boxleft5"><input name="txt_user_id" type="text" class="inputtypePersonnel" onChange="chkDigitPin(this.value);" onkeyup="doUnback_id(value)" value="<?echo $ID;?>" size="13" maxlength="13" readonly ="true"/></td>
                      </tr>
                      <tr align=center bgcolor="#F0F0F0" style="color:#666666;"> 
                      ...
                      <tr align=center bgcolor="#F0F0F0" style="color:#666666;"> 
                        ...
                        <td height="20" align="left" class="boxleft5">นามสกุล 
                          : </td>
                        <td colspan="2" align="left" class="boxleft5"><input name="txt_lsname" type="text" class="inputtypePersonnel" onkeyup="doUnback_lsname(value)" value="<?echo $lastname;?>" readonly ="true"/></td>
                      </tr>
                      <tr align=center bgcolor="#F0F0F0" style="color:#666666;"> 
						...
						?>
                          ...
                          <input type="hidden" name="CustomerType" value="<?if($type=="committee"){echo "1";} if($type=="personnel"){echo "2";}?>">
                          <input type="hidden" name="Position" value="<?echo $position?>">
                          <input type="hidden" name="PositionID" value="<?echo $PositionID?>"> 
                        </td>
                      </tr>
                      <tr align=center bgcolor="#F0F0F0" style="color:#666666;"> 
                        <td height="20" align=center>6.</td>
                        <td height="20" align="left" class="boxleft5">ชื่อหลักสูตร</td>
                        <td colspan="2" align="left" class="boxleft5"><input name="txt_eduname" type="text" class="inputtypePersonnel" id="txt_eduname"></td>
                      </tr>
                      <tr align=center bgcolor="#F0F0F0" style="color:#666666;"> 
                        <td height="20" align=center>7.</td>
                        <td height="20" align="left" class="boxleft5">หน่วยงานที่จัดอบรม</td>
                        <td colspan="2" align="left" class="boxleft5"><input name="txt_unit" type="text" class="inputtypePersonnel" id="txt_unit" ></td>
                      </tr>
                      <tr align=center bgcolor="#F0F0F0" style="color:#666666;"> 
                      ...
                      <tr align=center bgcolor="#F0F0F0" style="color:#666666;"> 
                        ...
                        <td colspan="2" align="left" class="boxleft5">รวมเวลา 
                          <input name="txt_datetotal" type="text" class="datetotal" id="txt_unit3" maxlength="3"  onKeyPress="check_number()" >
                          วัน </td>
                      </tr>
                      <tr align=center bgcolor="#F0F0F0" style="color:#666666;">
                        <td height="20" align=center>&nbsp;</td>
