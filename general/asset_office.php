  ...
  <tr>
    <td align="center" valign="top"><form name="form1" method="post" action="asset_insetinto.php">
        <table width="80%" border="0" cellpadding="0" cellspacing="0">
          <tr> 
            <td align="center" valign="top"><table style="margin: 7px 0px 0px 0px" cellSpacing="1" cellPadding="0" width="650" border="0" class=font1 bgcolor=white>
                <tr bgcolor="#92AED1" align=center class=font1 style="color:#333333;"> 
                  <td height="19" colspan=7 align=left><b>&nbsp; &nbsp;4. ข้อมูลทรัพย์สินประเภทครุภัณฑ์ 
                ...
                <tr bgcolor="#F0F0F0" align=center class=font1 style="color:#666666;"> 
                  <td height="20" align=left bgcolor="#F0F0F0">&nbsp;&nbsp;&nbsp; 
                    ...
                    <input type="hidden" name="assetcategory[]" value="<?echo $rowall[2];?>" id="assetcategory<?=$a;?>">
					...
					?>
                    <b> </b> </td>
                  <td height="20"><input name="assetamount[]" type="text" class="AssetSize" id ="assetamount<?=$a?>"value="<?echo $rowall[5]?>" style="text-align: center;" onchange="chkItem(this,document.getElementById('assetvalues<?=$a?>'),document.forms[0].assetapplying<?=$i?>);" onkeypress=check_number();></td>
				...
				?>
                  ...
                  <td height="20"> <input name="assetamount[]" type="text" class="Assetsize" id="assetamount<?=$a?>" style="text-align: center;" onkeypress=check_number();></td>
                  <td style="color:#FF0080;border:1px solid #F0F0F0;"><input name="assetvalues[]" type="text" class="Assetsize" id="assetvalues<?=$a;?>" style="text-align: right;" onkeypress=check_number();></td>
				...
				?>
                <tr bgcolor="#F0F0F0" align=center class=font1 style="color:#666666;"> 
                  <td colspan="6" align=left class="boxleft10" height="">	
                    <input type="hidden" name="row" value="<?=$a;?>">
                  </td>
                </tr>
              </table>
              <br>
              <input type="hidden" name="asset" value="office">
