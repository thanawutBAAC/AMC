          ...
          <tr> 
            <td align="center" valign="top"><table style="margin: 7px 0px 0px 0px" cellSpacing="1" cellPadding="0" width="720" border="0" class=font1 bgcolor=white>
                ...
                <tr bgcolor="#F0F0F0" class=font1 style="color:#666666;">
                  ...
                  <td height="20" align="center"><input name="assetamount[]" type="text" class="AssetSize" id ="assetamount<?=$a?>"value="<?echo $rowall[5]?>" style="text-align: center;"  onchange="chkItem(document.getElementById('assetsize<?=$a?>'),this,document.getElementById('assetvalues<?=$a?>'),document.forms[0].assetapplying<?=$i?>);" onkeypress=check_number();></td>
                  <td align="center" style="color:#FF0080;border:1px solid #F0F0F0;"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="font1">
                      <tr>
                        <td width="80%"><input name="assetvalues[]2" type="text" class="AssetSize" id="assetvalues[]" value="<?echo $rowall[6]?>" style="text-align: right;" onchange="chkItem(document.getElementById('assetsize<?=$a?>'),document.getElementById('assetamount<?=$a?>'),this,document.forms[0].assetapplying<?=$i?>);" onkeypress=check_number();></td>
