...
?>
<div style="margin-left:auto; margin-right:auto;  text-align: center "><strong> ข้อมูลผลการดำเนินงานเปรียบเทียบเป้าหมาย ( เฉพาะผลผลิตหลัก )</strong></div>
...
</span>&nbsp;<a href="works_detail.php?click=add" alt=" เพิ่มข้อมูล ">เพิ่มข้อมูล</a>
</div>
<table width="300" align="center"  class="gridtable" style="margin-top:5px;">
	<tr class='rows_blue'><td colspan="3"><center><b> รายละเอียดข้อมูล </b></center></td></tr>
	<tr class="rows_pink">
	...
	?>
			...
			<td align="center">
				<a href="works_detail.php?click=edit&year=<?=$fetch_skt[0]; ?>" target="right" alt=" แก้ไขข้อมูล " style='cursor: hand'>
