...
<div style=" float:left; left:70px; bottom:40px; position:absolute">
	<h3><font color="#FFFFFF"> ระบบบริหารข้อมูล สหกรณ์การเกษตรเพื่อการตลาดลูกค้า ธกส. </font></h3>
</div>
...
<div id="hideframe" style="float:left; position:absolute; right:2px; top:5px;" style="display:" class='Hide' >
	...
	<img src="icons/layout_delete.png" alt=" ซ่อนเมนู " class="images_icon"  > 
	</span>&nbsp;<a href="#" onClick=" HideFrame();"><font color="#FFFFFF">ซ่อนเมนู</font></a>&nbsp;
</div>
<div id="showframe" style="float:left; position:absolute; right:2px; top:5px;" style="display:none;" class='Show' >
	...
	<img src="icons/layout_add.png" alt=" แสดงเมนู " class="images_icon"  > 
</span>&nbsp;<a href="#" onClick=" ShowFrame();" ><font color="#FFFFFF">แสดงเมนู</font></a>&nbsp;
</div> 
<!--  แสดงหัวข้อข่าวสารตัววิ่ง -->
<div  style="float:left; left:3px; bottom:2px; position:absolute">
	<img src="images/icon_news.gif" alt=" ข่าวสารประจำวัน " > 
</div>
...
<!-- สิ้นสุดการแสดงข่าวสารตัววิ่ง -->
<!-- แสดงข้อมูลผู้เข้าใช้งาน -->
<div style=" float:left; right:65px; bottom:31px; position:absolute">
	ผู้เข้าใช้งาน : <font color="red"> <?=$user_online; ?></font>
</div>
<!--  สินสุดการแสดงผู้เข้าใช้งาน -->
<!--  แสดงข้อมูล logout -->
<div style=" float:left; right:65px; bottom:16px; position:absolute">ออกจากโปรแกรม :
	<a href="logout_user.php" onclick=" javascript: return confirm(' กรุณายืนยันการออกจากโปรแกรม ')"><font color="#6CAA35"><b>[ Logout ]</b></font></a>
</div>
<!-- สิ้นสุดแสดงข้อมูล logout -->

<!--  แสดงการกำหนดขนาดตัวอักษร -->
<div style=" float:left; right:32px; bottom:0px; position:absolute">
	 กำหนดขนาดอักษร : 
	<a href="#" onclick="javascript:parent.right.document.body.style.fontSize='0.8em' "> ปกติ </a>
	<a href="#" onclick="javascript:parent.right.document.body.style.fontSize='1em' "> ใหญ่ </a>
	<a href="#" onclick="javascript:parent.right.document.body.style.fontSize='1.2em' "> ใหญ่มาก </a>
</div>
<!--  สินสุดการกำหนดขนาดตัวอักษร -->
</body>
</html>