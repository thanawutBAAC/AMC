<?php session_start();
	...
	$sql.=" member_year,share_year, ";
	$sql.=" buy_income_first, buy_income_second, buy_income_third, buy_income_fourth, ";
	$sql.=" buy_expenses_first, buy_expenses_second, buy_expenses_third, buy_expenses_fourth, ";
	...
	$sql.=" sell_expenses_first, sell_expenses_second, sell_expenses_third, sell_expenses_fourth, ";
	...
	$sql.=" service_expenses_first, service_expenses_second, service_expenses_third, service_expenses_fourth, ";
