...
<br>
<div style="margin-left:auto; margin-right:auto;  text-align: center "> ภาพรวมแผนแปรรูป<u>การซื้อ/แปรรูปผลิตผล</u>การเกษตรของ สกต. <font color='red'>(ยอดซื้อ)</font>  แผน สก.กก4 </div>
<!-- ******************************************************************************************************************************************** -->
&nbsp;
...
<table  width="1700" class="gridtable" style="margin-left:5px; margin-right:5px; margin-top:10px;">
	<tr> 
		<td colspan="22" align="left">&nbsp;<font color="#0F7FAF"><b>รายงานการแปรรูปผลิตผลการเกษตร ยอดซื้อ สกต. ปี <?=$year; ?></b></font></td>
	</tr>
 <tr bgcolor="#33CCCC"> 
...
<a href="Excel_ReportSum09.php?year=<?=$year?>&div=<?=$div?>"><img src='../images/page_excel.gif' border='0'> ข้อมูล Excel </a></div></center>
<br>
</body>
</html>
<!-- ************************** -->
