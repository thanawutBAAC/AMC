<?php session_start();
	...
	$sql = " SELECT PlanTransBuy_year FROM PlanTransBuy ";
	$sql.=" WHERE amccode='".$code_online."' ";
	$sql.=" GROUP BY PlanTransBuy_year ";
	$sql.=" ORDER BY PlanTransBuy_year ";
...
?>
<div style="margin-left:auto; margin-right:auto;  text-align: center "> รายละเอียดแผน <u>การแปรรูปผลผลิตการเกษตร</u>
<font color='red'>(ยอดซื้อ)</font>  แผน สก.กก4 </div>
...
</span>&nbsp;<a href="PlanTransBuy_detail.php?click=add" alt=" เพิ่มข้อมูล ">เพิ่มข้อมูล</a>
</div>
<table width="300" align="center"  class="gridtable" style="margin-top:5px;">
	...
	?>
			...
			<td align="center">
				<a href="PlanTransBuy_detail.php?click=edit&year=<?=$fetch_plan[0]; ?>" target="right" alt=" แก้ไขข้อมูล " style='cursor: hand'>
				...
				<a href="PlanTransBuy_sql.php?click=del&year=<?=$fetch_plan[0]; ?>" target="right" alt="ลบข้อมูล" style='cursor: hand' onclick=" return confirm_delete('<?=$fetch_plan[0];?>') " >
