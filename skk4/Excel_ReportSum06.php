<?php session_start();
	...
	header('Content-Disposition: attachment; filename="ข้อมูลภาพรวมแผนด้านการรวบรวมผลผลิต การขาย.xls"');
	header("Expires: 0");
...
&nbsp;
<br>
<div style="margin-left:auto; margin-right:auto; margin-bottom:5px;  text-align: center "> รายละเอียดแผนภาพรวมการรวบรวมผลผลิตการเกษตรของ สกต. <font color='red'>(ยอดขาย)</font> แผน สก.กก4 </div>
<!-- ******************************************************************************************************************************************** -->
&nbsp;
