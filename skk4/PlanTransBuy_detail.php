...
if($click=='add')
{	$sql.=" AND Temp01.PlanTransBuy_year = '9999'  "; }
elseif($click=='edit')
...
$result_plan =	query($sql);
	...
	// จะได้รหัสผลผลิตที่ต้องการมาทั้งหมด แล้วคั่นด้วย # 
...
<!-- ******************************************************************************************************************************************** -->
<form name="Frm_TransBuy" action="PlanTransBuy_sql.php" method="post" onsubmit=" return check_submit();">
&nbsp;
<?
if($click=='add')
{	?>
...
<table  width="1700" class="gridtable" style="margin-left:5px; margin-right:15px; margin-top:10px;">
	<tr> 
		<td colspan="22" align="left">&nbsp;<font color="#0F7FAF"><b>รายละเอียดแผนการแปรรูปผลผลิตการเกษตร สกต. ปี <?=$year; ?></b></font></td>
	</tr>
 <tr bgcolor="#33CCCC"> 
