<?php session_start();
	...
	$sql.=" SUM(member_year), SUM(share_year), ";  // 0 1
	$sql.=" SUM(buy_income_first), SUM(buy_income_second), SUM(buy_income_third), SUM(buy_income_fourth), ";  //  2 3 4 5 
	$sql.=" SUM(buy_loan_first), SUM(buy_loan_second), SUM(buy_loan_third), SUM(buy_loan_fourth), ";  // 6 7 8 9
	$sql.=" SUM(buy_principal_first), SUM(buy_principal_second), SUM(buy_principal_third), SUM(buy_principal_fourth), ";  // 10 11 12 13
	$sql.=" SUM(buy_interest_first), SUM(buy_interest_second), SUM(buy_interest_third), SUM(buy_interest_fourth), ";  // 14 15 16 17
	$sql.=" SUM(sell_income_first), SUM(sell_income_second), SUM(sell_income_third), SUM(sell_income_fourth), ";  // 18 19 20 21
	$sql.=" SUM(sell_loan_first), SUM(sell_loan_second), SUM(sell_loan_third), SUM(sell_loan_fourth), ";     // 22 23 24 25
	$sql.=" SUM(sell_principal_first), SUM(sell_principal_second), SUM(sell_principal_third), SUM(sell_principal_fourth), ";    // 26 27 28 29
	$sql.=" SUM(sell_interest_first), SUM(sell_interest_second), SUM(sell_interest_third), SUM(sell_interest_fourth), ";    // 30 31 32 33
	$sql.=" SUM(transform_value_first), SUM(transform_value_second), SUM(transform_value_third), SUM(transform_value_fourth), ";   // 34 35 36 37
	$sql.=" SUM(transform_principal_first), SUM(transform_principal_second), SUM(transform_principal_third), SUM(transform_principal_fourth), ";   // 38 39 40 41
	$sql.=" SUM(transform_income_first), SUM(transform_income_second), SUM(transform_income_third), SUM(transform_income_fourth), ";   // 42 43 44 45
	$sql.=" SUM(service_capital_first), SUM(service_capital_second), SUM(service_capital_third), SUM(service_capital_fourth), ";   // 46 47 48 49	
	$sql.=" SUM(loan_income_first), SUM(loan_income_second), SUM(loan_income_third), SUM(loan_income_fourth), ";    //  50 51 52 53
	$sql.=" SUM(loan_capital_first), SUM(loan_capital_second), SUM(loan_capital_third), SUM(loan_capital_fourth), ";   // 54 55 56 57
	$sql.=" SUM(asset_61_first), SUM(asset_61_second), SUM(asset_61_third), SUM(asset_61_fourth), ";             //   58   59   60   61
	$sql.=" SUM(asset_62_first), SUM(asset_62_second), SUM(asset_62_third), SUM(asset_62_fourth), ";            //    62   63   64   65
	$sql.=" SUM(asset_63_first), SUM(asset_63_second), SUM(asset_63_third), SUM(asset_63_fourth), ";            //    66   67   68   69
	$sql.=" SUM(asset_64_first), SUM(asset_64_second), SUM(asset_64_third), SUM(asset_64_fourth), ";            //    70   71   72   73
	$sql.=" SUM(asset_65_first), SUM(asset_65_second), SUM(asset_65_third), SUM(asset_65_fourth), ";            //    74   75   76   77
	$sql.=" SUM(asset_66_first), SUM(asset_66_second), SUM(asset_66_third), SUM(asset_66_fourth), ";            //    78   79   80   81   
	$sql.=" SUM(asset_67_first), SUM(asset_67_second), SUM(asset_67_third), SUM(asset_67_fourth), ";            //    82   83   84   85
	$sql.=" SUM(asset_68_first), SUM(asset_68_second), SUM(asset_68_third), SUM(asset_68_fourth), ";            //    86   87   88   89 
	$sql.=" SUM(asset_69_first), SUM(asset_69_second), SUM(asset_69_third), SUM(asset_69_fourth), ";            //    90   91   92   93
	$sql.=" SUM(asset_610_first), SUM(asset_610_second), SUM(asset_610_third), SUM(asset_610_fourth), ";   //    94   95   96   97
	$sql.=" SUM(asset_611_first), SUM(asset_611_second), SUM(asset_611_third), SUM(asset_611_fourth), ";   //    98   99 100  101
	$sql.=" SUM(asset_612_first), SUM(asset_612_second), SUM(asset_612_third), SUM(asset_612_fourth), ";   //   102 103 104 105
	$sql.=" SUM(asset_613_first), SUM(asset_613_second), SUM(asset_613_third), SUM(asset_613_fourth), ";   //   106 107 108 109
	$sql.=" SUM(asset_614_first), SUM(asset_614_second), SUM(asset_614_third), SUM(asset_614_fourth), ";   //   110 111 112 113
	$sql.=" SUM(asset_615_first), SUM(asset_615_second), SUM(asset_615_third), SUM(asset_615_fourth), ";   //   114 115 116 117
	$sql.=" SUM(income_interest_first), SUM(income_interest_second), SUM(income_interest_third), SUM(income_interset_fourth), ";  
	// 118 119 120 121
	$sql.=" SUM(income_other_first), SUM(income_other_second), SUM(income_other_third), SUM(income_other_fourth), PlanMaster.Plan_year ";  //  122 123 124 125
...
function doCallAjax1() { 
	...
	var Temp_ans;
	var Array_ans;
	var url1 = 'Ajax_Frame_Master.php?year='+year;               // ดึงข้อมูลแผนการดำเนินงานปี
...
function doCallAjax2() { 
	...
	var Temp_ans;
	var Array_ans;
	var url2 = 'Ajax_Frame_Old_Master.php?year='+year;      // ดึงข้อมูลผลงานย้อนหลัง
...
<!-- ******************************************************************************************************************************************** -->
ข้อมูลปีบัญชี <input  name="year" type="text" size="6" class="txt_system" value="<?=$year; ?>"  readonly>

<!-- สิ้นสุดการแสดงปี -->
<span id='mySpan'></span>
<table  width="970" class="gridtable" style="margin-left:5px; margin-right:5px; margin-top:10px;">
	<tr> 
		<td colspan="10" align="left">&nbsp;<font color="#0F7FAF"><b>รายงานสรุปแผนการดำเนินงานประจำปี <?=$year; ?></b></font></td>
	</tr>
 <tr class="rows_pink"> 
  ...
  <tr class='rows_grey'>
	...
	<td align="center"><input type="text" size="7" maxlength='7' id="2x1" name="2x1" value="<?=number_format($fetch_master[0],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
 ...
 <tr>
  ...
  <tr class='rows_grey'>
	...
	<td align="center"><input type="text" size="7" maxlength='7' id="4x1" name="4x1" value="<?=number_format($fetch_master[1],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
 ...
 <tr class='rows_grey'>
	...
	<td align="center"><input type="text" size="7" maxlength="7"  id="8x2" name="8x2" value="<?=number_format($fetch_master[2],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" maxlength="7"  id="8x3" name="8x3" value="<?=number_format($fetch_master[3],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" maxlength="7"  id="8x4" name="8x4" value="<?=number_format($fetch_master[4],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" maxlength="7"  id="8x5" name="8x5" value="<?=number_format($fetch_master[5],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
</tr>
 <tr>
 ...
 <tr>
	...
	<td align="center"><input type="text" size="7" maxlength="7"  id="11x2" name="11x2" value="<?=number_format($fetch_master[6],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" maxlength="7"  id="11x3" name="11x3" value="<?=number_format($fetch_master[7],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" maxlength="7"  id="11x4" name="11x4" value="<?=number_format($fetch_master[8],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" maxlength="7"  id="11x5" name="11x5" value="<?=number_format($fetch_master[9],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
</tr>
 <tr class='rows_grey'>
	...
	<td align="center"><input type="text" size="7" maxlength="7"  id="12x2" name="12x2" value="<?=number_format($fetch_master[10],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" maxlength="7"  id="12x3" name="12x3" value="<?=number_format($fetch_master[11],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" maxlength="7"  id="12x4" name="12x4" value="<?=number_format($fetch_master[12],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" maxlength="7"  id="12x5" name="12x5" value="<?=number_format($fetch_master[13],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
</tr>
 <tr>
	...
	<td align="center"><input type="text" size="7" maxlength="7"  id="13x2" name="13x2" value="<?=number_format($fetch_master[14],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" maxlength="7"  id="13x3" name="13x3" value="<?=number_format($fetch_master[15],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" maxlength="7"  id="13x4" name="13x4" value="<?=number_format($fetch_master[16],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" maxlength="7"  id="13x5" name="13x5" value="<?=number_format($fetch_master[17],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
</tr>
 <tr class='rows_grey'>
 ...
 <tr>
	...
	<td align="center"><input type="text" size="7" maxlength="7"  id="17x2" name="17x2" value="<?=number_format($fetch_master[18],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" maxlength="7"  id="17x3" name="17x3" value="<?=number_format($fetch_master[19],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" maxlength="7"  id="17x4" name="17x4" value="<?=number_format($fetch_master[20],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" maxlength="7"  id="17x5" name="17x5" value="<?=number_format($fetch_master[21],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
</tr>
 <tr class='rows_grey'>
 ...
 <tr class='rows_grey'>
	...
	<td align="center"><input type="text" size="7" maxlength="7"  id="20x2" name="20x2" value="<?=number_format($fetch_master[22],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" maxlength="7"  id="20x3" name="20x3" value="<?=number_format($fetch_master[23],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" maxlength="7"  id="20x4" name="20x4" value="<?=number_format($fetch_master[24],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" maxlength="7"  id="20x5" name="20x5" value="<?=number_format($fetch_master[25],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
</tr>
 <tr>
	...
	<td align="center"><input type="text" size="7" maxlength="7"  id="21x2" name="21x2" value="<?=number_format($fetch_master[26],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" maxlength="7"  id="21x3" name="21x3" value="<?=number_format($fetch_master[27],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" maxlength="7"  id="21x4" name="21x4" value="<?=number_format($fetch_master[28],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" maxlength="7"  id="21x5" name="21x5" value="<?=number_format($fetch_master[29],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
</tr>
 <tr class='rows_grey'>
	...
	<td align="center"><input type="text" size="7" maxlength="7"  id="22x2" name="22x2" value="<?=number_format($fetch_master[30],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" maxlength="7"  id="22x3" name="22x3" value="<?=number_format($fetch_master[31],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" maxlength="7"  id="22x4" name="22x4" value="<?=number_format($fetch_master[32],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" maxlength="7"  id="22x5" name="22x5" value="<?=number_format($fetch_master[33],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
</tr>
 <tr>
 ...
 <tr class='rows_grey'>
	...
	<td align="center"><input type="text" size="7" id="24x2" name="24x2" value="<?=number_format($fetch_master[34],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" id="24x3" name="24x3" value="<?=number_format($fetch_master[35],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" id="24x4" name="24x4" value="<?=number_format($fetch_master[36],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();" ></td>
	<td align="center"><input type="text" size="7" id="24x5" name="24x5" value="<?=number_format($fetch_master[37],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
</tr>
 <tr class='rows_grey'>
	...
	<td align="center"><input type="text" size="7" id="25x2" name="25x2" value="<?=number_format($fetch_master[38],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" id="25x3" name="25x3" value="<?=number_format($fetch_master[39],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" id="25x4" name="25x4" value="<?=number_format($fetch_master[40],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" id="25x5" name="25x5" value="<?=number_format($fetch_master[41],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
</tr>
 <tr class='rows_grey'>
	...
	<td align="center"><input type="text" size="7" id="26x2" name="26x2" value="<?=number_format($fetch_master[42],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" id="26x3" name="26x3" value="<?=number_format($fetch_master[43],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" id="26x4" name="26x4" value="<?=number_format($fetch_master[44],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" id="26x5" name="26x5" value="<?=number_format($fetch_master[45],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
</tr>
 <tr class='rows_grey'>
 ...
 <tr>
	...
	<td align="center"><input type="text" size="7" maxlength="7"  id="31x2" name="31x2" value="<?=number_format($fetch_master[46],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" maxlength="7"  id="31x3" name="31x3" value="<?=number_format($fetch_master[47],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" maxlength="7"  id="31x4" name="31x4" value="<?=number_format($fetch_master[48],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" maxlength="7"  id="31x5" name="31x5" value="<?=number_format($fetch_master[49],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
</tr>
 <tr class='rows_grey'>
 ...
 <tr class='rows_grey'>
	...
	<td align="center"><input type="text" size="7" id="35x2" name="35x2" value="<?=number_format($fetch_master[50],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" id="35x3" name="35x3" value="<?=number_format($fetch_master[51],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" id="35x4" name="35x4" value="<?=number_format($fetch_master[52],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" id="35x5" name="35x5" value="<?=number_format($fetch_master[53],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
</tr>
 <tr>
	...
	<td align="center"><input type="text" size="7" maxlength="7"  id="36x2" name="36x2" value="<?=number_format($fetch_master[54],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" maxlength="7"  id="36x3" name="36x3" value="<?=number_format($fetch_master[55],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" maxlength="7"  id="36x4" name="36x4" value="<?=number_format($fetch_master[56],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" maxlength="7"  id="36x5" name="36x5" value="<?=number_format($fetch_master[57],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
</tr>
 <tr class='rows_grey'>
 ...
 <tr>
	...
	<td align="center"><input type="text" size="7" maxlength="7"  id="40x2" name="40x2" value="<?=number_format($fetch_master[58],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" maxlength="7"  id="40x3" name="40x3" value="<?=number_format($fetch_master[59],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" maxlength="7"  id="40x4" name="40x4" value="<?=number_format($fetch_master[60],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" maxlength="7"  id="40x5" name="40x5" value="<?=number_format($fetch_master[61],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
</tr>
 <tr class='rows_grey'>
	...
	<td align="center"><input type="text" size="7" maxlength="7"  id="41x2" name="41x2" value="<?=number_format($fetch_master[62],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" maxlength="7"  id="41x3" name="41x3" value="<?=number_format($fetch_master[63],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" maxlength="7"  id="41x4" name="41x4" value="<?=number_format($fetch_master[64],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" maxlength="7"  id="41x5" name="41x5" value="<?=number_format($fetch_master[65],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
</tr>
 <tr>
	...
	<td align="center"><input type="text" size="7" maxlength="7"  id="42x2" name="42x2" value="<?=number_format($fetch_master[66],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" maxlength="7"  id="42x3" name="42x3" value="<?=number_format($fetch_master[67],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" maxlength="7"  id="42x4" name="42x4" value="<?=number_format($fetch_master[68],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" maxlength="7"  id="42x5" name="42x5" value="<?=number_format($fetch_master[69],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
</tr>
 <tr class='rows_grey'>
	...
	<td align="center"><input type="text" size="7" maxlength="7"  id="43x2" name="43x2" value="<?=number_format($fetch_master[70],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" maxlength="7"  id="43x3" name="43x3" value="<?=number_format($fetch_master[71],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" maxlength="7"  id="43x4" name="43x4" value="<?=number_format($fetch_master[72],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" maxlength="7"  id="43x5" name="43x5" value="<?=number_format($fetch_master[73],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
</tr>
 <tr>
	...
	<td align="center"><input type="text" size="7" maxlength="7"  id="44x2" name="44x2" value="<?=number_format($fetch_master[74],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" maxlength="7"  id="44x3" name="44x3" value="<?=number_format($fetch_master[75],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" maxlength="7"  id="44x4" name="44x4" value="<?=number_format($fetch_master[76],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" maxlength="7"  id="44x5" name="44x5" value="<?=number_format($fetch_master[77],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
</tr>
 <tr class='rows_grey'>
	...
	<td align="center"><input type="text" size="7" maxlength="7"  id="45x2" name="45x2" value="<?=number_format($fetch_master[78],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" maxlength="7"  id="45x3" name="45x3" value="<?=number_format($fetch_master[79],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" maxlength="7"  id="45x4" name="45x4" value="<?=number_format($fetch_master[80],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" maxlength="7"  id="45x5" name="45x5" value="<?=number_format($fetch_master[81],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
</tr>
 <tr>
	...
	<td align="center"><input type="text" size="7" maxlength="7"  id="46x2" name="46x2" value="<?=number_format($fetch_master[82],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" maxlength="7"  id="46x3" name="46x3" value="<?=number_format($fetch_master[83],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" maxlength="7"  id="46x4" name="46x4" value="<?=number_format($fetch_master[84],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" maxlength="7"  id="46x5" name="46x5" value="<?=number_format($fetch_master[85],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
</tr>
 <tr class='rows_grey'>
	...
	<td align="center"><input type="text" size="7" maxlength="7"  id="47x2" name="47x2" value="<?=number_format($fetch_master[86],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" maxlength="7"  id="47x3" name="47x3" value="<?=number_format($fetch_master[87],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" maxlength="7"  id="47x4" name="47x4" value="<?=number_format($fetch_master[88],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" maxlength="7"  id="47x5" name="47x5" value="<?=number_format($fetch_master[89],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
</tr>
 <tr>
	...
	<td align="center"><input type="text" size="7" maxlength="7"  id="48x2" name="48x2"  value="<?=number_format($fetch_master[90],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" maxlength="7"  id="48x3" name="48x3"  value="<?=number_format($fetch_master[91],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" maxlength="7"  id="48x4" name="48x4"  value="<?=number_format($fetch_master[92],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" maxlength="7"  id="48x5" name="48x5"  value="<?=number_format($fetch_master[93],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
</tr>
 <tr class='rows_grey'>
	...
	<td align="center"><input type="text" size="7" maxlength="7"  id="49x2" name="49x2"  value="<?=number_format($fetch_master[94],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" maxlength="7"  id="49x3" name="49x3"  value="<?=number_format($fetch_master[95],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" maxlength="7"  id="49x4" name="49x4"  value="<?=number_format($fetch_master[96],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" maxlength="7"  id="49x5" name="49x5"  value="<?=number_format($fetch_master[97],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
</tr>
 <tr class='rows_grey'>
	...
	<td align="center"><input type="text" size="7" maxlength="7"  id="50x2" name="50x2"  value="<?=number_format($fetch_master[98],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" maxlength="7"  id="50x3" name="50x3"  value="<?=number_format($fetch_master[99],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" maxlength="7"  id="50x4" name="50x4"  value="<?=number_format($fetch_master[100],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" maxlength="7"  id="50x5" name="50x5"  value="<?=number_format($fetch_master[101],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
</tr>
 <tr class='rows_grey'>
	...
	<td align="center"><input type="text" size="7" maxlength="7"  id="51x2" name="51x2"  value="<?=number_format($fetch_master[102],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" maxlength="7"  id="51x3" name="51x3"  value="<?=number_format($fetch_master[103],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" maxlength="7"  id="51x4" name="51x4"  value="<?=number_format($fetch_master[104],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" maxlength="7"  id="51x5" name="51x5"  value="<?=number_format($fetch_master[105],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
</tr>
 <tr class='rows_grey'>
	...
	<td align="center"><input type="text" size="7" maxlength="7"  id="52x2" name="52x2"  value="<?=number_format($fetch_master[106],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" maxlength="7"  id="52x3" name="52x3"  value="<?=number_format($fetch_master[107],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" maxlength="7"  id="52x4" name="52x4"  value="<?=number_format($fetch_master[108],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" maxlength="7"  id="52x5" name="52x5"  value="<?=number_format($fetch_master[109],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
</tr>
 <tr class='rows_grey'>
	...
	<td align="center"><input type="text" size="7" maxlength="7"  id="53x2" name="53x2"  value="<?=number_format($fetch_master[110],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" maxlength="7"  id="53x3" name="53x3"  value="<?=number_format($fetch_master[111],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" maxlength="7"  id="53x4" name="53x4"  value="<?=number_format($fetch_master[112],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" maxlength="7"  id="53x5" name="53x5"  value="<?=number_format($fetch_master[113],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
</tr>
 <tr class='rows_grey'>
	...
	<td align="center"><input type="text" size="7" maxlength="7"  id="54x2" name="54x2"  value="<?=number_format($fetch_master[114],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" maxlength="7"  id="54x3" name="54x3"  value="<?=number_format($fetch_master[115],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" maxlength="7"  id="54x4" name="54x4"  value="<?=number_format($fetch_master[116],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" maxlength="7"  id="54x5" name="54x5"  value="<?=number_format($fetch_master[117],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
</tr>
 <tr>
 ...
 <tr>
	...
	<td align="center"><input type="text" size="7" maxlength="7"  id="59x2" name="59x2" value="<?=number_format($fetch_master[118],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" maxlength="7"  id="59x3" name="59x3" value="<?=number_format($fetch_master[119],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" maxlength="7"  id="59x4" name="59x4" value="<?=number_format($fetch_master[120],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" maxlength="7"  id="59x5" name="59x5" value="<?=number_format($fetch_master[121],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
</tr>
 <tr class='rows_grey'>
	...
	<td align="center"><input type="text" size="7" maxlength="7"  id="60x2" name="60x2" value="<?=number_format($fetch_master[122],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" maxlength="7"  id="60x3" name="60x3" value="<?=number_format($fetch_master[123],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" maxlength="7"  id="60x4" name="60x4" value="<?=number_format($fetch_master[124],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
	<td align="center"><input type="text" size="7" maxlength="7"  id="60x5" name="60x5" value="<?=number_format($fetch_master[125],0,'','')?>" class="txt_num" onKeyPress="return isNumberKey(this); " onKeyUp=" update_master();"></td>
</tr>
 <tr>
