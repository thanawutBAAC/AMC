<?php session_start();
	...
	header('Content-Disposition: attachment; filename="รายงานรวบรวมผลผลิตทั้งหมด มุมมอง ฝสข.xls"');
	header("Expires: 0");
...
<head>
<title>รายงานรวบรวมผลผลิตทั้งหมด สกต มุมมอง ฝสข</title>
...
/*   เป้าหมายการจำหน่ายผลิตผล ของสกต */
	...
	WHILE($fetch_report = fetch_row($result_report)) { 
		...
		else    // แสดงธรรมดา
		{
			...
			{  $temp_report.="<tr>";  }
			$temp_report.=" <td width='80'>&nbsp;".trim($fetch_report[1])."</td>";   // สกต
