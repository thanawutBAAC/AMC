...
function doCallAjax() {  //  ข้อมูลมูลค่าจัดหาสินค้ามาจำหน่าย  หมวดที่ 2
	...
	if (varItem=='1'){ // มุมมอง ฝสข
		 url = 'Ajax_report03.php?year='+year+'&month='+month+'&div='+div+'&province='+province+'&province_name='+province_name;
		 }else{  // มุมมอง สินค้า 
		 url = 'Ajax_report031.php?year='+year+'&month='+month+'&div='+div+'&province='+province+'&province_name='+province_name;
	} // end if else 
...
<?php  // แสดงข้อมูลหัวรายงาน
	$report_header ="3. รายงานมูลค่าธุรกิจจัดหาสินค้ามาจำหน่าย ";
	$report_type ="1";
