...
function doCallAjax() {  //  ข้อมูลธุรกิจรวบรวมผลิตผล  หมวดที่ 3
	...
	var url = 'Ajax_report06.php?year='+year+'&month='+month+'&div='+div+'&province='+province+'&province_name='+province_name;    // ดึงข้อมูลรายงาน
...
<?php  // แสดงข้อมูลหัวรายงาน
	$report_header =" 6. มูลค่าธุรกิจรวบรวมผลผลิต (มุมมองฝสข.,จังหวัด) หน่วย:ตัน   ";
	$report_type ="1";
