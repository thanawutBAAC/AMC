...
function doCallAjax() {  //  แสดงข้อมูลรายงานทั่วไป
	...
	var	url = 'Ajax_report16.php?year='+year+'&month='+month+'&div='+div;   
	...
	<tr>
		<td colspan="4" valign="top" >
			<table width="699" border="0" cellpadding="0" cellspacing="0" style="margin: 1 1 1 1;">
				<tr height="30px">
		  			<td align="center" bgcolor="#EEEEEE"><strong> รายงานรวบรวมผลิตผลใช้ติดตามเป้าหมาย ( สำหรับ ฝพช.กพธ. ติดตามเป้าหมาย) </strong></td>
				</tr>
			</table>
		</td>	
	</tr>
