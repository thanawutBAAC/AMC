<?php session_start();
    ...
    $temp_report.=" <td colspan='15' align='left'>&nbsp;<font color='#0F7FAF'><b>3. มูลค่าธุรกิจรวบรวมผลิตผล (เชื่มโยงธุรกิจการผลิตการตลาดโดยขบวนการสหกรณ์และองค์กรชุมชน) </b></font></td>";
	$temp_report.="</tr>";
