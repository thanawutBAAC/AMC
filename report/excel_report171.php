<?php session_start();
	...
	header('Content-Disposition: attachment; filename="รายงานการดำเนินงานตามแผนธุรกิจของ สกต. แสดงเป้าหมาย.xls"');
	header("Expires: 0");
...
<head>
<title>รายงานการดำเนินงานตามแผนธุรกิจของ สกต. แสดงเป้าหมาย</title>
...
<?
	...
	$temp_report.="<table width='2100' border='1' style='margin-top:25px; margin-left:5px; margin-right:5px;'> ";
	...
	$temp_report.="    <td colspan='18' bgcolor='#CCFFCC'>&nbsp;&nbsp; ผลการดำเนินงาน ณ สิ้นเดือน ".$month_thai[$month]." ปี ".$year."</td> ";
	$temp_report.="</tr> ";
