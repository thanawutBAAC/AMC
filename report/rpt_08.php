...
function doCallAjax() {  //  แสดงข้อมูลรายงานทั่วไป
	...
	var url = 'Ajax_report08.php?year='+year+'&month='+month+'&div='+div+'&province='+province+'&province_name='+province_name;    // ดึงข้อมูลรายงาน
...
<?php  // แสดงข้อมูลหัวรายงาน
	$report_header ="8. มูลค่าธุรกิจรวบรวมผลผลิต ธุรกิจรวบรวม ตัวชี้วัดของ Tris (มุมมองผลิตผล)";
	$report_type ="1";
