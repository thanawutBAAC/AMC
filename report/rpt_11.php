...
function doCallAjax() {  //  แสดงข้อมูลรายงาน
	HttPRequest = false; 
	...
	var url = 'Ajax_report11.php?year='+year+'&month='+month+'&div='+div+'&province='+province+'&province_name='+province_name;    // ดึงข้อมูลรายงาน
...
<?php  // แสดงข้อมูลหัวรายงาน
	$report_header =" 11. มูลค่าธุรกิจรวบรวมผลผลิต ธุรกิจจำหน่าย ตัวชี้วัดของ Tris (มุมมองฝสข.,จังหวัด) ";
	$report_type ="1";
