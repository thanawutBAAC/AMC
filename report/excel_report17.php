<?php session_start();
	...
	header('Content-Disposition: attachment; filename="รายงานการดำเนินงานตามแผนธุรกิจของ สกต. ไม่แสดงเป้าหมาย.xls"');
	header("Expires: 0");
...
<head>
<title>รายงานการดำเนินงานตามแผนธุรกิจของ สกต. ไม่แสดงเป้าหมาย</title>
...
/* ************************************************ */
	...
	WHILE($fetch_report = fetch_row($result_report)) { 
		...
		{
			$temp_report.="<tr bgcolor='#99CCFF'>";  // สรุปรวมแต่ละฝ่าย
