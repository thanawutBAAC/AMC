...
//	var target = document.getElementByName("target");  //  1 แสดงเป้าหมาย   0 ไม่แสดงเป้าหมาย

	var target = document.getElementsByName('target');
	var url ='';
	for(var i = 0; i < target.length; i++)
	{
	    if(target[i].checked== true) {   // ตรวจสอบว่าเลือกให้แสดงเป้าหมายหรือไม่  1 แสดง 0 ไม่แสดง
	...
	if (varItem=='0'){
		 url = 'Ajax_report17.php?year='+year+'&month='+month+'&div='+div;    // ดึงข้อมูลรายงาน ไม่แสดงเป้าหมาย
	}else{
		 url = 'Ajax_report171.php?year='+year+'&month='+month+'&div='+div;    // ดึงข้อมูลรายงาน แสดงเป้าหมาย
	} // end if else 
...
<body>
<table width="750" style="margin-left:5px; text-align: center; margin-top:8px; margin-bottom:0px;" border="0" cellpadding="0" cellspacing="0" class="report" >
	<tr>
		<td colspan="4" valign="top" >
			<table width="749" border="0" cellpadding="0" cellspacing="0" style="margin: 1 1 1 1;">
				<tr height="30px">
		  			<td align="center" bgcolor="#EEEEEE"><strong> รายงานการดำเนินงานตามแผนธุรกิจของ สกต. </strong></td>
				</tr>
			</table>
		</td>	
	</tr>
...
<tr height="25" valign="bottom">
	...
	<td align="left">&nbsp;
		<input type="radio" name='target'  value='1'> แสดงเป้าหมาย
		<input type="radio" name='target'  value='0' checked> ไม่แสดงเป้าหมาย
	</td>
</tr>
<tr height="35">
	<td>&nbsp;</td>
