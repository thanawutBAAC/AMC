<?php session_start();
    ...
    $temp_report.=" <td colspan='11' align='left'>&nbsp;<font color='#0F7FAF'><b>".$report_detail_name."</b></font></td> ";
	$temp_report.="</tr> ";
	$temp_report.="<tr class='rows_purple'>  ";
	$temp_report.=" <td rowspan='3' width='40' align='center' valign='middle'>ฝ่าย</td> ";
	$temp_report.=" <td rowspan='3' width='150' align='center' valign='middle'>สกต.</td> ";
...
// สร้างข้อมูลส่วนเนือ้หากลางตาราง
	...
	$sql.=" Temp02.data10, Temp02.data11, Temp02.data12, Temp02.data13, Temp02.data14, userlogin.amccode ";
	...
	$sql.=" AND BaseReportDetail.report_detail_code='".$report_detail_code."' ";
	if($div!='0')
	...
	$temp_report.=" <td><a href='#' OnClick=' doCallAjax99(\"".trim($fetch_report[11])."\",\"".trim($fetch_report[2])."\")' > &nbsp;".trim($fetch_report[2])."</a></td>";
