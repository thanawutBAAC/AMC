...
function doCallAjax() {  //  ข้อมูลมูลค่าจัดหาสินค้ามาจำหน่าย  หมวดที่ 2
	...
	var url = 'Ajax_report02.php?year='+year+'&month='+month+'&div='+div+'&province='+province+'&province_name='+province_name;    // ดึงข้อมูลรายงาน
...
<?php  // แสดงข้อมูลหัวรายงาน
	$report_header ="2. รายงานข้อมูลทั่วไป สกต. ประจำเดือน ";
	$report_type ="1";
